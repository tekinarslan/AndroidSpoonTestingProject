...
public abstract class Page implements PageTreeNode {
  ...
  protected com.tekinarslan.spoon.wizard.model.ModelCallbacks mCallbacks;
  ...
  protected Page(com.tekinarslan.spoon.wizard.model.ModelCallbacks callbacks, String title) {
