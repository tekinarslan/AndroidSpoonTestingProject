package com.tekinarslan.spoon.wizard.ui;
...
import com.tekinarslan.spoon.R;
import com.tekinarslan.spoon.wizard.model.Page;
...
public class SingleChoiceFragment extends ListFragment {
  ...
  private com.tekinarslan.spoon.wizard.ui.PageFragmentCallbacks mCallbacks;
  ...
  @Override public void onAttach(Activity activity) {
    ...
    if (!(activity instanceof com.tekinarslan.spoon.wizard.ui.PageFragmentCallbacks)) {
      throw new ClassCastException("Activity must implement PageFragmentCallbacks");
    }

    mCallbacks = (com.tekinarslan.spoon.wizard.ui.PageFragmentCallbacks) activity;
  }
